  ...
  <section>
        ...
        <tbody>
          <?php foreach ($params['notes'] ?? [] as $note) : ?>
            <tr>
              ...
              <td>
                <a href="/systemNotes/?action=show&id=<?php echo $note['id'] ?>">
                  <button>Szczegóły</button>
                </a>
                <a href="/systemNotes/?action=delete&id=<?php echo $note['id'] ?>">
                  <button>Usuń</button>
                </a>
              </td>
            </tr>
    ...
    <ul class="pagination">
      <?php if ($currentPage !== 1) : ?>
        <li>
          <a href="/systemNotes/?page=<?php echo $currentPage - 1 . $paginationUrl ?>">
            <button> Prev </button>
          </a>
        </li>
      <?php endif; ?>
      <?php for ($i = 1; $i <= $pages; $i++) : ?> <li>
          <a href="/systemNotes/?page=<?php echo $i . $paginationUrl ?>">
